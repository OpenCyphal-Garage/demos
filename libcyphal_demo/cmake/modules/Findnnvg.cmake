...
function(create_dsdl_target ARG_TARGET_NAME
    ...
    list(APPEND NNVG_CMD_ARGS --experimental-languages --target-language)
    ...
    if (CMAKE_CXX_STANDARD STREQUAL "14")
        list(APPEND NNVG_CMD_ARGS "--language-standard=cetl++14-17")
    else ()
        list(APPEND NNVG_CMD_ARGS "--language-standard=c++${CMAKE_CXX_STANDARD}-pmr")
    endif ()
